"use strict";(()=>{var i={};i.id=554,i.ids=[554],i.modules={399:i=>{i.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:i=>{i.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8893:i=>{i.exports=require("buffer")},4770:i=>{i.exports=require("crypto")},7702:i=>{i.exports=require("events")},2048:i=>{i.exports=require("fs")},2615:i=>{i.exports=require("http")},8791:i=>{i.exports=require("https")},8216:i=>{i.exports=require("net")},9801:i=>{i.exports=require("os")},5315:i=>{i.exports=require("path")},6162:i=>{i.exports=require("stream")},2452:i=>{i.exports=require("tls")},7360:i=>{i.exports=require("url")},1568:i=>{i.exports=require("zlib")},7791:(i,e,t)=>{t.r(e),t.d(e,{originalPathname:()=>l,patchFetch:()=>R,requestAsyncStorage:()=>d,routeModule:()=>c,serverHooks:()=>_,staticGenerationAsyncStorage:()=>E});var s={};t.r(s),t.d(s,{GET:()=>o});var a=t(9303),n=t(8716),p=t(670),r=t(7070),u=t(8555);async function o(i){try{let{searchParams:e}=new URL(i.url),t=e.get("companyId"),s=await (0,u.rH)(t?parseInt(t):void 0);return r.NextResponse.json({success:!0,data:s})}catch(i){return console.error("[api/suppliers] Hata:",i),r.NextResponse.json({success:!1,error:"Tedarik\xe7iler alınamadı"},{status:500})}}let c=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/suppliers/route",pathname:"/api/suppliers",filename:"route",bundlePath:"app/api/suppliers/route"},resolvedPagePath:"C:\\Users\\caner.karadag\\Cursor_Projeler\\Tedarikci_Irsaliye\\app\\app\\api\\suppliers\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:d,staticGenerationAsyncStorage:E,serverHooks:_}=c,l="/api/suppliers/route";function R(){return(0,p.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:E})}},8555:(i,e,t)=>{t.d(e,{Kv:()=>l,Vs:()=>_,Z$:()=>E,b_:()=>o,cu:()=>p,dr:()=>m,ny:()=>c,r7:()=>R,rH:()=>n,sA:()=>d,v$:()=>u,yV:()=>r});var s=t(9665),a=t(3377);async function n(i){if(null!=i&&""!==i){let e="string"==typeof i?parseInt(i):i;if(!isNaN(e))return(await (0,s.i6)`SELECT * FROM suppliers WHERE company_id = ${e} ORDER BY supplier_name`).rows}return(await (0,s.i6)`SELECT * FROM suppliers ORDER BY supplier_name`).rows}async function p(i){return(await (0,s.i6)`SELECT * FROM suppliers WHERE id = ${i}`).rows[0]||null}async function r(i={}){let{shippingNumber:e,status:t,supplierCode:n,companyId:p,page:r=1,limit:u=10}=i,o=[],c=[],d=1;if(e&&(o.push(`sd.shipping_number LIKE $${d}`),c.push(`%${e}%`),d++),t&&"all"!==t){let i=(0,a.iX)(t);o.push(`sd.status = $${d}`),c.push(i),d++}n&&(o.push(`s.supplier_code = $${d}`),c.push(n),d++),p&&(o.push(`s.company_id = $${d}`),c.push(p),d++);let E=o.length>0?`WHERE ${o.join(" AND ")}`:"",_=`
